...
def calcular_dosagem_abcp(tipo_cimento):
    # Lógica baseada nas tabelas fixas que você enviou cruzando fcj e slump
    ...
    vol_ar = 0.02 # 2% fixo de ar incorporado
    ...
    # Efeito da umidade da areia na obra (soma na areia, desconta da água limpa)
...
if erro_brita or erro_areia:
    ...
    with col_m32:
        ...
        st.metric("Teor de Argamassa", f"{teor_argamassa_escolhido}%")
